	...
	<div class="panel panel-warning">
		...
		<div class = "panel-body">
			...
			<div class="form-group">
				...
				@if($viviente->gaia_id == null)
				{!! Form::select('gaia_id', array('1' => 'Draco', '2' => 'Fénix', '3' => 'Lycan', '4' => 'Quimera', '5' => 'Unicornio'),'',['class'=>'form-control select']) !!}
				@else
				{!! Form::select('gaia_id', array('1' => 'Draco', '2' => 'Fénix', '3' => 'Lycan', '4' => 'Quimera', '5' => 'Unicornio'), $viviente->gaia_id,['class'=>'form-control select']) !!}
				@endif
			</div>
			<!--Observaciones-->
			<div class="form-group">
