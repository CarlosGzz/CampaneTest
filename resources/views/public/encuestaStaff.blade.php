                    ...
                    <div class="x_content" id="contenido">
                        ...
                        {!! Form::open(['route' => 'staff.store', 'method' => 'POST', 'class'=>'form-horizontal form-label-left', 'id'=>'staffForm','data-parsley-validate']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::text('nombre','',['class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'Victoria','maxlength' => '120', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::text('apellidoPaterno','',['class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'Gonzalez','maxlength' => '120', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::text('apellidoMaterno','',['class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'Martinez','maxlength' => '120', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::date('fechaNacimiento', \Carbon\Carbon::now(), ['class'=>'flatpickr form-control','required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    {!! Form::text('carrera','',['class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'Carrera','minlength' => '5','maxlength' => '120','title'=>'Por favor escribe el nombre completo de tu carrera', 'required']) !!}
                                </div>
                                <div class="col-md-3 col-sm-3 col-xs-6">
                                    {!! Form::text('universidad','',['class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'Universidad','maxlength' => '120','title'=>'Por favor escribe las siglas de tu Universidad', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::select('gaia_id', array('1' => 'Draco', '2' => 'Fénix', '3' => 'Lycan', '4' => 'Quimera', '5' => 'Unicornio'), '',['class'=>'form-control select', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::select('pulsera', array('ninguna' => 'Ninguna','verde' => 'Verde', 'blanca' => 'Blanca', 'roja' => 'Roja', 'plateada' => 'Plateada'), '',['class'=>'form-control select', 'required'])!!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::email('correo','',['class'=>'form-control col-md-7 col-xs-12', 'placeholder' => 'staff@kemen.com','maxlength' => '120', 'required']) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    {!! Form::text('telefonoCel','',['class'=>'form-control col-md-7 col-xs-12', 'placeholder' => '8117784890','maxlength' => '120', 'required']) !!}
                                </div>
                            </div>
